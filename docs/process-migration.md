...
The generation of the Payment Order ID was manually adjusted so that it does not use a full UUID but shortens it to 4 characters and also concatenates it with “PO-” as in the examples provided.


#### ▶️ Phase 6: Docker for database initialization
